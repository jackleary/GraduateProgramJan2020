...
public class Employee implements Serializable{
	...
	// a constructor helps developer to create a usable object for simulations
	// Public <ClassName>
	// Polymorphism
	...
	public Employee () {
		...
		System.out.println("eno: "+getEmpno()+"\nname: "+getName()+
				"\nunit salary: "+getUnitDaySalary()+"\ndesignation: "+getDesignation());
	}
